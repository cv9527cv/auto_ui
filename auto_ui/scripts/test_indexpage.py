...
class TestIndexPage():
    ...
    def setup_class(self):
        self.base_url = 'http://192.168.18.149:9527/#/homepage/index'
    ...
    def test_click_evidencea(self):
        ...
        pytest.assume(Browser.dr.current_url == 'http://192.168.18.149:9527/#/evidence/evidence')

    # @pytest.mark.skip(msg='任性')
    def test_click_warninga(self):
        Browser.dr.get(self.base_url)
        self.page.search_warninga.click()
        pytest.assume(Browser.dr.current_url == 'http://192.168.18.149:9527/#/alarm/bind')
    ...
    def test_click_indexa(self):
        ...
        pytest.assume(Browser.dr.current_url == 'http://192.168.18.149:9527/#/homepage/index')
    ...
    def test_logout(self):
        ...
        pytest.assume(self.page.search_logoutalter.text == '退出登录？')
        # Browser.dr.refresh()
